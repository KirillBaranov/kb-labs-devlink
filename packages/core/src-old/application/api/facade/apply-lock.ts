...
import { walkPatterns } from '@devlink/shared/utils/fs';
import { promises as fsp } from 'fs';
import { join, relative } from 'path';
import {
  applyLockFile as applyLockFileApplication,
  type ApplyLockFileOptions,
  type ApplyLockFileResult,
} from '@devlink/application/devlink/legacy/lock';
import type { LockFile } from '@devlink/application/devlink/legacy/lock';

export type { ApplyLockFileOptions, ApplyLockFileResult } from '@devlink/application/devlink/legacy/lock';
